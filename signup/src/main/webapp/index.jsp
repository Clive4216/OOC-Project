...
<title>Food Sustainability Tracker</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Food Sustainability Tracker</a>
			<button
	...
	<!-- Food Log Section-->
	<section class="page-section" id="foodLog">
    <div class="container">
        <!-- Food Log Section Heading-->
        <h1>------------------------------------------------------------------------</h1>
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Food Log</h2>
        <!-- Icon Divider-->
...
<section class="page-section" id="foodDetails">
	...
	<section class="page-section bg-primary text-white mb-0" id="about">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-black">About</h2>
			<!-- Icon Divider-->
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Our Food Sustainability Tracker is a digital tool that is designed to help
					individuals and organisations monitor, assess,and improve the environmental impact of their
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Food Sustainability Tracker Done By Clive & Toseeb</h1>
			<!-- Icon Divider-->
